                      ...
                      prefixElement={
                        <div className="relative">
                          <button
                            ...
                            className="w-24 px-3 py-3 rounded bg-surface-container text-on-surface-variant font-label-ui text-label-ui font-semibold border border-outline-variant/30 focus:bg-surface-container-lowest focus:outline-none focus:ring-2 focus:ring-secondary flex items-center justify-between"
                          >
